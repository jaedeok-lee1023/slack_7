...
def main():
    for cluster in clusters:
        ...
        notice_msg = (
            ...
            f"\n"
            f"\n"
            f":k체크: 클러스터 내 모든 도로의 경우 :자동차:*제한속도 30Km 미만* :출입금지_기호: \n"
            f":k체크: 심야 시간대에는 화물차량 운행이 빈번하여 *꼭! 안전운행 필수* :k느낌표: \n"
            f":k체크: 1층 출차로 램프 :화살표1: 흡연실 or 직원식당 *무단횡단 금지* :출입금지: \n"
            f":k체크: 각 층 입출차로 *램프 역주행 금지* :x_표시를_한_남성: \n"
            f":k체크: 입차 차단기 (1층 / 2층~7층) 주행 차로 임의 변경 금지 (사각지대로 사고 위험) :위로_화살표: \n"
            f"\n"
